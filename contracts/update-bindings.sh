...
forge bind -b ../crates/types/src/contract_bindings --select "^(Angstrom|PoolManager|PoolGate|MockRewardsManager|MintableMockERC20)$" --alloy --module --skip-cargo-toml --overwrite

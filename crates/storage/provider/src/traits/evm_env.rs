...
/// A provider type that knows chain specific information required to configure
/// an [Env](reth_revm_primitives::primitives::Env)
///
/// This type is mainly used to provide required data to configure the EVM
/// environment.
#[auto_impl::auto_impl(&, Arc)]
pub trait EvmEnvProvider: Send + Sync {
    /// Fills the [CfgEnv] and [BlockEnv] fields with values specific to the
    /// given [BlockHashOrNumber].
    fn fill_env_at(
        &self,
        cfg: &mut CfgEnv,
    ...
    /// Fills the default [CfgEnv] and [BlockEnv] fields with values specific to
    /// the given [Header].
    ...
    /// Fills the [BlockEnv] fields with values specific to the given
    /// [BlockHashOrNumber].
    ...
    /// Fills the [CfgEnv] fields with values specific to the given
    /// [BlockHashOrNumber].

...
pub trait HistoryWriter: Send + Sync {
    ...
    /// Insert account change index to database. Used inside AccountHistoryIndex
    /// stage
    ...
    /// Insert storage change index to database. Used inside StorageHistoryIndex
    /// stage
    ...
    /// Read account/storage changesets and update account/storage history
    /// indices.

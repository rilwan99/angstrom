...
pub mod MockRewardsManager {
    ...
    ///Container type for the return parameters of the
    /// [`updateAfterTickMove(bytes32,int24,int24)`](updateAfterTickMoveCall)
    /// function.
    #[allow(non_camel_case_types, non_snake_case)]
    #[derive(Clone)]
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for updateAfterTickMoveCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { id: tuple.0, lastTick: tuple.1, newTick: tuple.2 }
                }
            }
        }
        {
        ...
        > MockRewardsManagerInstance<T, P, N>
    {
        ...
        pub fn updateAfterTickMove(
            ...
            self.call_builder(&updateAfterTickMoveCall { id, lastTick, newTick })
        }
    }
    /// Event filters.
    #[automatically_derived]

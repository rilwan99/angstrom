...
pub mod IPoolManager {
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> =
                (alloy::sol_types::private::FixedBytes<32>, alloy::sol_types::private::U256);
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(_t: alloy_sol_types::private::AssertTypeEq<UnderlyingRustTuple>) {
                match _t {
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> =
                (PoolKey, ModifyLiquidityParams, alloy::sol_types::sol_data::Bytes);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <PoolKey as alloy::sol_types::SolType>::RustType,
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn extsload_0(
                        ...
                        <extsload_0Call as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn extsload_1(
                        ...
                        <extsload_1Call as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn settleFor(
                        ...
                        <settleForCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn exttload_0(
                        ...
                        <exttload_0Call as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn extsload_2(
                        ...
                        <extsload_2Call as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn exttload_1(
                        ...
                        <exttload_1Call as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
    ...
    >(
        provider: P
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IPoolManagerInstance<T, P, N>>>
    {
        ...
        > IPoolManagerInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IPoolManagerInstance<T, P, N>> {

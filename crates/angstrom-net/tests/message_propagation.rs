...
// testnet.connect_all_peers()).await;     assert!(res.is_ok(), "failed to
// connect all peers within 3 seconds");     let sk =
// blsful::SecretKey::random(&mut thread_rng());
...
//         )
//         .await;
//         assert_eq!(res, Ok(true), "failed to receive and react to commit
// within 1 second");
...
//         )
//         .await;
//         assert_eq!(res, Ok(true), "failed to receive and react to preposal
// within 1 second");
...
//         )
//         .await;
//         assert_eq!(res, Ok(true), "failed to receive and react to proposal
// within 1 second");     }
// }

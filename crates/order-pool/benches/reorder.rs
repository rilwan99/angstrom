...
use order_pool::test_utils::MockTransaction;
use proptest::{
    prelude::*,
...
mod implementations {
    ...
    use order_pool::PoolTransaction;

    use super::*;

    /// This implementation appends the transactions and uses [Vec::sort_by]
    ...
    /// This implementation appends the transactions and uses
    /// [Vec::sort_unstable_by] function for sorting.
    #[derive(Default)]
    ...
    /// This implementation uses BinaryHeap which is drained and reconstructed
    /// on each reordering.
    #[derive(Default)]

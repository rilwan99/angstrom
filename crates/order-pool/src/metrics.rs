...
pub struct OrderPoolMetrics {
    ...
    /// Total amount of memory used by the transactions in the pending sub-pool
    /// in bytes
    ...
    /// Total amount of memory used by the transactions in the basefee sub-pool
    /// in bytes
    ...
    /// Total amount of memory used by the transactions in the queued sub-pool
    /// in bytes
...
pub struct MaintainPoolMetrics {
    /// Number of currently dirty addresses that need to be updated in the pool
    /// by fetching account info
